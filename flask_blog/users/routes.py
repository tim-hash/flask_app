...
from flask_blog.users.forms import (RegistrationForm, LoginForm,
                                    UpdateAccountForm, RequestResetPassword, ResetPasswordForm)
...
def register():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(user)
        db.session.commit()
        flash('Your account as been been created. You are now able to log in', 'success')
...
def reset_token(token):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Your password as been been updated. You are now able to log in', 'success')
        return redirect(url_for('users.login'))
